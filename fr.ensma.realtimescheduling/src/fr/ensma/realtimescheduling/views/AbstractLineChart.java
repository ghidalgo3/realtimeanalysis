...
/**
 * Abstract class for all line charts. Sets up the eclipse view to have a chart
 * on the left side and a control component on the right. Subclasses define the
 * data sources and any extra controls.
 * 
 * @author Gustavo
 */
public abstract class AbstractLineChart extends ViewPart {
	...
	/**
	 * This is the meat of how this class creates its view. The Composite
	 * parameter is the View that we will be children of, Eclipse passes this
	 * in. Any widgets or whatever that we want to display has to directly or
	 * indirectly be parented to that Composite parent.
	 */
	@Override
	...
	/**
	 * ChartComposite is a class provided by JFreeChart to allow a JFreeChart
	 * object to exist within Eclipse. Even though the chart is a composite, I
	 * don't think it is a good idea to make anything a child of the chart.
	 * 
	 * @param parent
	...
	/**
	 * Subclasses create any control widgets they want and parent them to the
	 * parameter of this method. This method should return a single composite
	 * that is the parent of the controls. NOTE: The parameter returned should
	 * not be the parameter passed in, though the parameter returned should be a
	 * child of the parameter passed in.
	 * 
	 * @param parent
	 * @return
	 */
	...
	/**
	 * Used by a 'query' button that asks to update the UI based on the state of
	 * the system.
	 */
