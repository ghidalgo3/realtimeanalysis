...
/**
 * This is the item provider adapter for a {@link fr.ensma.realtimescheduling.Interval} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interval_start_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interval_start_feature", "_UI_Interval_type"),
				 RealtimeschedulingPackage.Literals.INTERVAL__START,
				 true,
				 false,
				 false,
	...
	protected void addEndPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Interval_end_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Interval_end_feature", "_UI_Interval_type"),
				 RealtimeschedulingPackage.Literals.INTERVAL__END,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.REAL_VALUE_IMAGE,
